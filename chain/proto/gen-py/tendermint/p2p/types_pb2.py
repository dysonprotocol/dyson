...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z1github.com/cometbft/cometbft/proto/tendermint/p2p'),
...
_NETADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\342\336\037\002ID'), json_name='id', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\002IP'), json_name='ip', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_PROTOCOLVERSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\003P2P'), json_name='p2p', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_DEFAULTNODEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), json_name='protocolVersion', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\rDefaultNodeID'), json_name='defaultNodeId', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='listenAddr', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), json_name='other', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_DEFAULTNODEINFOOTHER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\nRPCAddress'), json_name='rpcAddress', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
