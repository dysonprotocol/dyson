...
_CONNECTIONEND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='versions', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_COUNTERPARTY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), json_name='prefix', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxExpectedTimePerBlock', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
