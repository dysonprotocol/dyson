...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cosmos/consensus/module/v1/module.proto',
...
_MODULE = _descriptor.Descriptor(
  name='Module',
  full_name='cosmos.consensus.module.v1.Module',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='authority', full_name='cosmos.consensus.module.v1.Module.authority', index=0,
...
Module = _reflection.GeneratedProtocolMessageType('Module', (_message.Message,), dict(
  DESCRIPTOR = _MODULE,
  __module__ = 'cosmos.consensus.module.v1.module_pb2'
