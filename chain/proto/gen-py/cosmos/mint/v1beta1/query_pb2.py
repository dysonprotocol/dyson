...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,cosmos_dot_mint_dot_v1beta1_dot_mint__pb2.DESCRIPTOR,amino_dot_amino__pb2.DESCRIPTOR,])
...
_QUERYINFLATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\250\347\260*\001'), json_name='inflation', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYANNUALPROVISIONSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\250\347\260*\001'), json_name='annualProvisions', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
