...
_QUERYVALIDATORDISTRIBUTIONINFOREQUEST = _descriptor.Descriptor(
  name='QueryValidatorDistributionInfoRequest',
  full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='validator_address', full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest.validator_address', index=0,
...
_QUERYVALIDATORDISTRIBUTIONINFORESPONSE = _descriptor.Descriptor(
  name='QueryValidatorDistributionInfoResponse',
  full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='operator_address', full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse.operator_address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\322\264-\035cosmos.ValidatorAddressString'), json_name='operatorAddress', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='self_bond_rewards', full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse.self_bond_rewards', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins\250\347\260*\001'), json_name='selfBondRewards', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='commission', full_name='cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse.commission', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'), json_name='commission', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYVALIDATORSLASHESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='startingHeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='endingHeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_QUERYVALIDATORSLASHESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\250\347\260*\001'), json_name='slashes', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_QUERYDELEGATIONTOTALREWARDSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins\250\347\260*\001'), json_name='total', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYCOMMUNITYPOOLRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins\250\347\260*\001'), json_name='pool', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYVALIDATORDISTRIBUTIONINFORESPONSE.fields_by_name['self_bond_rewards'].message_type = cosmos_dot_base_dot_v1beta1_dot_coin__pb2._DECCOIN
_QUERYVALIDATORDISTRIBUTIONINFORESPONSE.fields_by_name['commission'].message_type = cosmos_dot_base_dot_v1beta1_dot_coin__pb2._DECCOIN
...
DESCRIPTOR.message_types_by_name['QueryValidatorDistributionInfoRequest'] = _QUERYVALIDATORDISTRIBUTIONINFOREQUEST
DESCRIPTOR.message_types_by_name['QueryValidatorDistributionInfoResponse'] = _QUERYVALIDATORDISTRIBUTIONINFORESPONSE
...
QueryValidatorDistributionInfoRequest = _reflection.GeneratedProtocolMessageType('QueryValidatorDistributionInfoRequest', (_message.Message,), dict(
  DESCRIPTOR = _QUERYVALIDATORDISTRIBUTIONINFOREQUEST,
  __module__ = 'cosmos.distribution.v1beta1.query_pb2'
  # @@protoc_insertion_point(class_scope:cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest)
  ))
_sym_db.RegisterMessage(QueryValidatorDistributionInfoRequest)

QueryValidatorDistributionInfoResponse = _reflection.GeneratedProtocolMessageType('QueryValidatorDistributionInfoResponse', (_message.Message,), dict(
  DESCRIPTOR = _QUERYVALIDATORDISTRIBUTIONINFORESPONSE,
  __module__ = 'cosmos.distribution.v1beta1.query_pb2'
  # @@protoc_insertion_point(class_scope:cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse)
  ))
_sym_db.RegisterMessage(QueryValidatorDistributionInfoResponse)
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='cosmos.distribution.v1beta1.Query.ValidatorDistributionInfo',
    index=1,
    containing_service=None,
    input_type=_QUERYVALIDATORDISTRIBUTIONINFOREQUEST,
    output_type=_QUERYVALIDATORDISTRIBUTIONINFORESPONSE,
    serialized_options=_b('\202\323\344\223\002=\022;/cosmos/distribution/v1beta1/validators/{validator_address}'),
  ),
  _descriptor.MethodDescriptor(
