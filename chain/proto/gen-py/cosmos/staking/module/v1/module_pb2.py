...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cosmos/staking/module/v1/module.proto',
...
_MODULE = _descriptor.Descriptor(
  name='Module',
  full_name='cosmos.staking.module.v1.Module',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hooks_order', full_name='cosmos.staking.module.v1.Module.hooks_order', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='hooksOrder', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authority', full_name='cosmos.staking.module.v1.Module.authority', index=1,
...
Module = _reflection.GeneratedProtocolMessageType('Module', (_message.Message,), dict(
  DESCRIPTOR = _MODULE,
  __module__ = 'cosmos.staking.module.v1.module_pb2'
