...
_QUERYACCOUNTSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\312\264-\034cosmos.auth.v1beta1.AccountI'), json_name='accounts', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_QUERYACCOUNTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\312\264-\034cosmos.auth.v1beta1.AccountI'), json_name='account', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYMODULEACCOUNTSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\312\264-\"cosmos.auth.v1beta1.ModuleAccountI'), json_name='accounts', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYMODULEACCOUNTBYNAMERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\312\264-\"cosmos.auth.v1beta1.ModuleAccountI'), json_name='account', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_ADDRESSBYTESTOSTRINGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='addressBytes', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_ADDRESSBYTESTOSTRINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='addressString', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYACCOUNTADDRESSBYIDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\030\001'), json_name='id', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='account_id', full_name='cosmos.auth.v1beta1.QueryAccountAddressByIDRequest.account_id', index=1,
...
_QUERYACCOUNTADDRESSBYIDRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\322\264-\024cosmos.AddressString'), json_name='accountAddress', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYACCOUNTINFOREQUEST = _descriptor.Descriptor(
  name='QueryAccountInfoRequest',
  full_name='cosmos.auth.v1beta1.QueryAccountInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='cosmos.auth.v1beta1.QueryAccountInfoRequest.address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERYACCOUNTINFORESPONSE = _descriptor.Descriptor(
  name='QueryAccountInfoResponse',
  full_name='cosmos.auth.v1beta1.QueryAccountInfoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='info', full_name='cosmos.auth.v1beta1.QueryAccountInfoResponse.info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERYACCOUNTINFORESPONSE.fields_by_name['info'].message_type = cosmos_dot_auth_dot_v1beta1_dot_auth__pb2._BASEACCOUNT
...
DESCRIPTOR.message_types_by_name['QueryAccountInfoRequest'] = _QUERYACCOUNTINFOREQUEST
DESCRIPTOR.message_types_by_name['QueryAccountInfoResponse'] = _QUERYACCOUNTINFORESPONSE
...
QueryAccountInfoRequest = _reflection.GeneratedProtocolMessageType('QueryAccountInfoRequest', (_message.Message,), dict(
  DESCRIPTOR = _QUERYACCOUNTINFOREQUEST,
  __module__ = 'cosmos.auth.v1beta1.query_pb2'
  # @@protoc_insertion_point(class_scope:cosmos.auth.v1beta1.QueryAccountInfoRequest)
  ))
_sym_db.RegisterMessage(QueryAccountInfoRequest)

QueryAccountInfoResponse = _reflection.GeneratedProtocolMessageType('QueryAccountInfoResponse', (_message.Message,), dict(
  DESCRIPTOR = _QUERYACCOUNTINFORESPONSE,
  __module__ = 'cosmos.auth.v1beta1.query_pb2'
  # @@protoc_insertion_point(class_scope:cosmos.auth.v1beta1.QueryAccountInfoResponse)
  ))
_sym_db.RegisterMessage(QueryAccountInfoResponse)
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002\037\022\035/cosmos/auth/v1beta1/accounts'),
  ),
  _descriptor.MethodDescriptor(
    name='Account',
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002)\022\'/cosmos/auth/v1beta1/accounts/{address}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002)\022\'/cosmos/auth/v1beta1/address_by_id/{id}'),
  ),
  _descriptor.MethodDescriptor(
    name='Params',
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002\035\022\033/cosmos/auth/v1beta1/params'),
  ),
  _descriptor.MethodDescriptor(
    name='ModuleAccounts',
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002&\022$/cosmos/auth/v1beta1/module_accounts'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002-\022+/cosmos/auth/v1beta1/module_accounts/{name}'),
  ),
  _descriptor.MethodDescriptor(
    name='Bech32Prefix',
    ...
    serialized_options=_b('\202\323\344\223\002\035\022\033/cosmos/auth/v1beta1/bech32'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002-\022+/cosmos/auth/v1beta1/bech32/{address_bytes}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002.\022,/cosmos/auth/v1beta1/bech32/{address_string}'),
  ),
  _descriptor.MethodDescriptor(
    name='AccountInfo',
    full_name='cosmos.auth.v1beta1.Query.AccountInfo',
    index=9,
    containing_service=None,
    input_type=_QUERYACCOUNTINFOREQUEST,
    output_type=_QUERYACCOUNTINFORESPONSE,
    serialized_options=_b('\210\347\260*\001\202\323\344\223\002-\022+/cosmos/auth/v1beta1/account_info/{address}'),
  ),
])
