...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cosmos/auth/v1beta1/tx.proto',
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,cosmos__proto_dot_cosmos__pb2.DESCRIPTOR,cosmos_dot_msg_dot_v1_dot_msg__pb2.DESCRIPTOR,amino_dot_amino__pb2.DESCRIPTOR,cosmos_dot_auth_dot_v1beta1_dot_auth__pb2.DESCRIPTOR,])
...
_MSGUPDATEPARAMS = _descriptor.Descriptor(
  ...
  full_name='cosmos.auth.v1beta1.MsgUpdateParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='authority', full_name='cosmos.auth.v1beta1.MsgUpdateParams.authority', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='params', full_name='cosmos.auth.v1beta1.MsgUpdateParams.params', index=1,
  ...
  serialized_options=_b('\202\347\260*\tauthority\212\347\260*!cosmos-sdk/x/auth/MsgUpdateParams'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_MSGUPDATEPARAMSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='cosmos.auth.v1beta1.MsgUpdateParamsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_MSGUPDATEPARAMS.fields_by_name['params'].message_type = cosmos_dot_auth_dot_v1beta1_dot_auth__pb2._PARAMS
...
MsgUpdateParams = _reflection.GeneratedProtocolMessageType('MsgUpdateParams', (_message.Message,), dict(
  ...
  __module__ = 'cosmos.auth.v1beta1.tx_pb2'
...
_MSG = _descriptor.ServiceDescriptor(
  name='Msg',
  full_name='cosmos.auth.v1beta1.Msg',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='UpdateParams',
    full_name='cosmos.auth.v1beta1.Msg.UpdateParams',
    index=0,
