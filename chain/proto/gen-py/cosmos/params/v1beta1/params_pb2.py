...
_PARAMETERCHANGEPROPOSAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000\250\347\260*\001'), json_name='changes', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
  ...
  serialized_options=_b('\210\240\037\000\312\264-\032cosmos.gov.v1beta1.Content\212\347\260*\"cosmos-sdk/ParameterChangeProposal'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
