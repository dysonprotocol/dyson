...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cosmos/store/internal/kv/v1beta1/kv.proto',
  package='cosmos.store.internal.kv.v1beta1',
  syntax='proto3',
  serialized_options=_b('Z\036cosmossdk.io/store/internal/kv'),
...
_PAIRS = _descriptor.Descriptor(
  name='Pairs',
  full_name='cosmos.store.internal.kv.v1beta1.Pairs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pairs', full_name='cosmos.store.internal.kv.v1beta1.Pairs.pairs', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), json_name='pairs', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_PAIR = _descriptor.Descriptor(
  name='Pair',
  full_name='cosmos.store.internal.kv.v1beta1.Pair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cosmos.store.internal.kv.v1beta1.Pair.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='cosmos.store.internal.kv.v1beta1.Pair.value', index=1,
...
Pairs = _reflection.GeneratedProtocolMessageType('Pairs', (_message.Message,), dict(
  DESCRIPTOR = _PAIRS,
  __module__ = 'cosmos.store.internal.kv.v1beta1.kv_pb2'
