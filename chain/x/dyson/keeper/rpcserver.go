...
import (
	...
	ibcapplicationsinterchain_accountshostv1types "github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/host/types"
...
// Keeper: ibcapplicationsinterchain_accountscontrollerv1keeper
// Types: ibcapplicationsinterchain_accountscontrollerv1types
// github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/controller/keeper
func (rpcservice *RpcService) Ibcapplicationsinterchainaccountscontrollerv1queryinterchainaccount(_ *http.Request, req *RpcReq, response *string) (err error) {
	var msg ibcapplicationsinterchain_accountscontrollerv1types.QueryInterchainAccountRequest
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	r, err := rpcservice.k.ibcapplicationsinterchain_accountscontrollerv1keeper.InterchainAccount(rpcservice.ctx, &msg)
	if err != nil {
		return err
	}
	*response = string(rpcservice.k.cdc.MustMarshalJSON(r))
...
// Types: ibcapplicationsinterchain_accountscontrollerv1types
// github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/controller/keeper
func (rpcservice *RpcService) Ibcapplicationsinterchainaccountscontrollerv1queryparams(_ *http.Request, req *RpcReq, response *string) (err error) {
	var msg ibcapplicationsinterchain_accountscontrollerv1types.QueryParamsRequest
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	r, err := rpcservice.k.ibcapplicationsinterchain_accountscontrollerv1keeper.Params(rpcservice.ctx, &msg)
	if err != nil {
		return err
	}
	*response = string(rpcservice.k.cdc.MustMarshalJSON(r))
...
// Types: ibcapplicationsinterchain_accountscontrollerv1types
// github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/controller/keeper
func (rpcservice *RpcService) Ibcapplicationsinterchainaccountscontrollerv1sendmsgregisterinterchainaccount(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibcapplicationsinterchain_accountscontrollerv1keeper.NewMsgServerImpl(rpcservice.k.ibcapplicationsinterchain_accountscontrollerv1keeper).RegisterInterchainAccount
	var msg ibcapplicationsinterchain_accountscontrollerv1types.MsgRegisterInterchainAccount
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
...
// Types: ibcapplicationsinterchain_accountscontrollerv1types
// github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/controller/keeper
func (rpcservice *RpcService) Ibcapplicationsinterchainaccountscontrollerv1sendmsgsendtx(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibcapplicationsinterchain_accountscontrollerv1keeper.NewMsgServerImpl(rpcservice.k.ibcapplicationsinterchain_accountscontrollerv1keeper).SendTx
	var msg ibcapplicationsinterchain_accountscontrollerv1types.MsgSendTx
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelopeninit(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelOpenInit
	var msg ibccorechannelv1types.MsgChannelOpenInit
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelOpenInit
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelopentry(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelOpenTry
	var msg ibccorechannelv1types.MsgChannelOpenTry
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelOpenTry
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelopenack(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelOpenAck
	var msg ibccorechannelv1types.MsgChannelOpenAck
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelOpenAck
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelopenconfirm(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelOpenConfirm
	var msg ibccorechannelv1types.MsgChannelOpenConfirm
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelOpenConfirm
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelcloseinit(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelCloseInit
	var msg ibccorechannelv1types.MsgChannelCloseInit
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelCloseInit
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgchannelcloseconfirm(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).ChannelCloseConfirm
	var msg ibccorechannelv1types.MsgChannelCloseConfirm
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.ChannelCloseConfirm
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgrecvpacket(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).RecvPacket
	var msg ibccorechannelv1types.MsgRecvPacket
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.RecvPacket
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgtimeout(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).Timeout
	var msg ibccorechannelv1types.MsgTimeout
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.Timeout
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgtimeoutonclose(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).TimeoutOnClose
	var msg ibccorechannelv1types.MsgTimeoutOnClose
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.TimeoutOnClose
	//
	defer func() {
		if r := recover(); r != nil {
...
// Types: ibccorechannelv1types
// None
func (rpcservice *RpcService) Ibccorechannelv1sendmsgacknowledgement(_ *http.Request, req *RpcReq, response *string) (err error) {
	//handler := ibckeeper.NewMsgServerImpl(rpcservice.k.ibckeeper).Acknowledgement
	var msg ibccorechannelv1types.MsgAcknowledgement
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	handler := rpcservice.k.ibckeeper.Acknowledgement
	//
	defer func() {
		if r := recover(); r != nil {
...
// Keeper: ibcapplicationsinterchain_accountshostv1keeper
// Types: ibcapplicationsinterchain_accountshostv1types
// github.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/host/keeper
func (rpcservice *RpcService) Ibcapplicationsinterchainaccountshostv1queryparams(_ *http.Request, req *RpcReq, response *string) (err error) {
	var msg ibcapplicationsinterchain_accountshostv1types.QueryParamsRequest
	err = rpcservice.k.cdc.UnmarshalJSON([]byte(req.S), &msg)
	if err != nil {
		return err
	}
	r, err := rpcservice.k.ibcapplicationsinterchain_accountshostv1keeper.Params(rpcservice.ctx, &msg)
	if err != nil {
		return err
	}
	*response = string(rpcservice.k.cdc.MustMarshalJSON(r))
