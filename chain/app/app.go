...
func New(
	...
	app.DysonKeeper = *dysonmodulekeeper.NewKeeper(
		...
		keys[dysonmoduletypes.MemStoreKey],
		app.BankKeeper,
		app.AccountKeeper,
		app.DistrKeeper,
		app.EvidenceKeeper,
	...
	app.mm.SetOrderEndBlockers(dysonModule.Name(), crisistypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName)
