...
import { WeightedVoteOption } from "./module/types/cosmos/gov/v1/gov"
import { Deposit } from "./module/types/cosmos/gov/v1/gov"
import { Proposal } from "./module/types/cosmos/gov/v1/gov"
import { TallyResult } from "./module/types/cosmos/gov/v1/gov"
import { Vote } from "./module/types/cosmos/gov/v1/gov"
import { DepositParams } from "./module/types/cosmos/gov/v1/gov"
import { VotingParams } from "./module/types/cosmos/gov/v1/gov"
import { TallyParams } from "./module/types/cosmos/gov/v1/gov"
...
export default {
	...
	actions: {
		...
		async QueryProposals({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryProposals API Node Unavailable. Could not perform query: ' +  (e.error?.message || e.message))
			}
		},
		...
		async QueryVote({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryVote API Node Unavailable. Could not perform query: ' +  (e.error?.message || e.message))
			}
		},
		...
		async QueryVotes({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryVotes API Node Unavailable. Could not perform query: ' +  (e.error?.message || e.message))
			}
		},
		...
		async QueryDeposit({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryDeposit API Node Unavailable. Could not perform query: ' +  (e.error?.message || e.message))
			}
		},
		...
		async QueryDeposits({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryDeposits API Node Unavailable. Could not perform query: ' +  (e.error?.message || e.message))
			}
		},
		...
		async sendMsgDeposit({ rootGetters }, { value, fee = [], memo = '', gas = "200000"  }) {
			try {
	...
	gas: gas}, memo})
		...
		async sendMsgVoteWeighted({ rootGetters }, { value, fee = [], memo = '', gas = "200000"  }) {
			try {
				const txClient=await initTxClient(rootGetters)
