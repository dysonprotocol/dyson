...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgCancelUnbondingDelegation: (data: MsgCancelUnbondingDelegation): EncodeObject => ({ typeUrl: "/cosmos.staking.v1beta1.MsgCancelUnbondingDelegation", value: MsgCancelUnbondingDelegation.fromPartial( data ) }),
