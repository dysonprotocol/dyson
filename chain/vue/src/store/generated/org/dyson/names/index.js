    ...
    actions: {
        ...
        async QueryName({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                throw new SpVuexError('QueryClient:QueryName', 'API Node Unavailable. Could not perform query: ' + e.error.message);
            }
        },
        async QueryNameAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                throw new SpVuexError('QueryClient:QueryNameAll', 'API Node Unavailable. Could not perform query: ' + e.error.message);
            }
        },
        async QueryResolve({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                throw new SpVuexError('QueryClient:QueryResolve', 'API Node Unavailable. Could not perform query: ' + e.error.message);
            }
        },
        async QueryGenerateCommit({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryGenerateCommit({ ...query, 'pagination.key': value.pagination.next_key })).data;
                    value = mergeResults(value, next_values);
                }
                ...
                throw new SpVuexError('QueryClient:QueryGenerateCommit', 'API Node Unavailable. Could not perform query: ' + e.error.message);
            }
        },
