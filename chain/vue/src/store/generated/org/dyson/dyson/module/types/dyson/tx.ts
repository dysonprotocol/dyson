...
const baseMsgCreateSchedualedRun: object = { creator: '', height: 0, gas: 0 }

export const MsgCreateSchedualedRun = {
  encode(message: MsgCreateSchedualedRun, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateSchedualedRun {
    ...
    const message = { ...baseMsgCreateSchedualedRun } as MsgCreateSchedualedRun
...
const baseMsgCreateSchedualedRunResponse: object = {}

export const MsgCreateSchedualedRunResponse = {
  encode(_: MsgCreateSchedualedRunResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateSchedualedRunResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgCreateSchedualedRunResponse } as MsgCreateSchedualedRunResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
const baseMsgUpdateSchedualedRun: object = { creator: '', index: '' }

export const MsgUpdateSchedualedRun = {
  encode(message: MsgUpdateSchedualedRun, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator)
    }
    if (message.index !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateSchedualedRun {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgUpdateSchedualedRun } as MsgUpdateSchedualedRun
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseMsgUpdateSchedualedRunResponse: object = {}

export const MsgUpdateSchedualedRunResponse = {
  encode(_: MsgUpdateSchedualedRunResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateSchedualedRunResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgUpdateSchedualedRunResponse } as MsgUpdateSchedualedRunResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
const baseMsgDeleteSchedualedRun: object = { creator: '', index: '' }

export const MsgDeleteSchedualedRun = {
  encode(message: MsgDeleteSchedualedRun, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator)
    }
    if (message.index !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteSchedualedRun {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgDeleteSchedualedRun } as MsgDeleteSchedualedRun
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseMsgDeleteSchedualedRunResponse: object = {}

export const MsgDeleteSchedualedRunResponse = {
  encode(_: MsgDeleteSchedualedRunResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteSchedualedRunResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgDeleteSchedualedRunResponse } as MsgDeleteSchedualedRunResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
const baseMsgCreateStorage: object = { creator: '', index: '', data: '', force: false }
...
export const MsgCreateStorageResponse = {
  encode(_: MsgCreateStorageResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateStorageResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgCreateStorageResponse } as MsgCreateStorageResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
const baseMsgUpdateStorage: object = { creator: '', index: '', data: '', force: false }
...
export const MsgUpdateStorageResponse = {
  encode(_: MsgUpdateStorageResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateStorageResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgUpdateStorageResponse } as MsgUpdateStorageResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
export const MsgDeleteStorageResponse = {
  encode(_: MsgDeleteStorageResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteStorageResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgDeleteStorageResponse } as MsgDeleteStorageResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
export const MsgCreateScriptResponse = {
  encode(message: MsgCreateScriptResponse, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateScriptResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgCreateScriptResponse } as MsgCreateScriptResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const MsgUpdateScriptResponse = {
  encode(message: MsgUpdateScriptResponse, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
    return writer
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateScriptResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgUpdateScriptResponse } as MsgUpdateScriptResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const MsgDeleteScriptResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteScriptResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgDeleteScriptResponse } as MsgDeleteScriptResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
