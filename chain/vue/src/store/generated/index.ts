...
import CosmosCosmosSdkCosmosBaseNodeV1Beta1 from './cosmos/cosmos-sdk/cosmos.base.node.v1beta1'
...
import CosmosCosmosSdkCosmosGovV1 from './cosmos/cosmos-sdk/cosmos.gov.v1'
import CosmosCosmosSdkCosmosGovV1Beta1 from './cosmos/cosmos-sdk/cosmos.gov.v1beta1'
import CosmosCosmosSdkCosmosGroupV1 from './cosmos/cosmos-sdk/cosmos.group.v1'
import CosmosCosmosSdkCosmosMintV1Beta1 from './cosmos/cosmos-sdk/cosmos.mint.v1beta1'
import CosmosCosmosSdkCosmosNftV1Beta1 from './cosmos/cosmos-sdk/cosmos.nft.v1beta1'
...
export default { 
  ...
  CosmosCosmosSdkCosmosBaseNodeV1Beta1: load(CosmosCosmosSdkCosmosBaseNodeV1Beta1, 'cosmos.base.node.v1beta1'),
  ...
  CosmosCosmosSdkCosmosGovV1: load(CosmosCosmosSdkCosmosGovV1, 'cosmos.gov.v1'),
  CosmosCosmosSdkCosmosGovV1Beta1: load(CosmosCosmosSdkCosmosGovV1Beta1, 'cosmos.gov.v1beta1'),
  CosmosCosmosSdkCosmosGroupV1: load(CosmosCosmosSdkCosmosGroupV1, 'cosmos.group.v1'),
  CosmosCosmosSdkCosmosMintV1Beta1: load(CosmosCosmosSdkCosmosMintV1Beta1, 'cosmos.mint.v1beta1'),
  CosmosCosmosSdkCosmosNftV1Beta1: load(CosmosCosmosSdkCosmosNftV1Beta1, 'cosmos.nft.v1beta1'),
