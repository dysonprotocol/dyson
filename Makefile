...
write-commit-info:
		...
		sed -i 's;^.*AUTOMATICALLY GENERATED LDFLAGS COMMIT.*$$;   - "-X github.com/cosmos/cosmos-sdk/version.Commit=${CI_COMMIT_SHORT_SHA}" # AUTOMATICALLY GENERATED COMMIT;' chain/config.yml
